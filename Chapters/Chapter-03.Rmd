...
The most widely used of these is the productlimit estimator, also known as the Kaplan-Meier estimator. 
...
# Exercises  3.1. Refer to Fig. 3.2. Find the median survival, and a 95% confidence interval for  the median. Explain why the upper limit of the confidence interval is undefined.  
